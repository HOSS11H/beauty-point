...
const resources = {
    ...
    ar: {
        translation: {
            ...
            'Employee Schedule': 'جدول عمل الموظفين',
            'Settings': 'الإعدادات',
            'Report': 'التقارير',
            'Booking': 'الحجوزات',
            'Deal': 'العروض',
            ...
            'Product': 'منتجات',
            'salon: ': 'الصالون: ',
            'No Seats Found': 'لا توجد مقاعد',
            'reserve seat': 'حجز مقعد',
            'comment': 'تعليق',
            'Seat Reserved': 'تم حجز المقعد',
            'Seat Details Updated': 'تم تحديث تفاصيل المقعد',
            ...
            'sales to citizens ( private health services / national private education': 'المبيعات للمواطنين ( الخدمات الصحية الخاصة / التعليم الأهلي الخاص )',
            'current sales that goes under zero percentage': 'المبيعات المحلية الخاضعة للنسبة الصفرية',
            'forgiven sales': 'المبيعات المعفاة',
            'exports': 'الصادرات',
            'Vat on expenses and other intputs': 'ضرييبة القيمة المضافة علي النفقات والمدخلات الأخري',
            'purchases under main perecntage': 'المشتريات الخاضعة للنسبة الأساسية',
            'imports under main vat which paid in customs': 'الاستيرادات الخاضعة لضريبة القيمة المضافة بالنسبة الأساسية والتي تدفع في الجمارك',
            'Imports subject to value added vat and to which the reverse charge mechanism applies': 'الاستيرادات الخاضعة لضريبة القيمة المضافة والتي ينطبق عليها الية الاحتساب العكسي',
            'purchases under zero perecetage': 'المشتريات الخاضعة للنسبة الصفرية',
            'forgiven purchases': 'المشتريات المعفاة',
            'due vat': 'صافي ضريبة القيمة المضافة المستحقة',
            'Total vat payable for the tax period': 'مجموع الضريبة المستحقة عن الفترة الضريبية',
            'Total recoverable tax for the tax period': 'مجموع الضريبة القابلة للاسترداد التابعة للفترة الضريبية',
