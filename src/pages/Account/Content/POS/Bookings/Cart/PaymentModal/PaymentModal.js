...
const PaymentModal = props => {
    ...
    const { open, handleClose, items, bookingId, hasVat, resetCart, dateTime, bookingData} = props;
    ...
    const [payments, setPayments] = useState(bookingData.payments)
    ...
    const bookOrderHandler = () => {
        ...
        axios.put(`/vendors/bookings/${bookingId}`, data)
            .then(response => {
                handleClose()
