...
const Cart = props => {
    ...
    const { show, onClose, artistData, fetchCouponsHandler } = props;
                ...
                <CustomCardMui>
                    <Grid container spacing={0} >
                        <Grid item xs={12} md={3}>
                            <CartHeadliner activeStep={activeStep} salonName={artistData.companyName} steps={steps} />
                        </Grid>
                        <Grid item xs={12} md={ activeStep === 0 || activeStep === 6 ? 9 : 6}>
                            <CartContent sx={{ width: '100%' }}>
                                <CartBody>
                                    ...
                                    {
                                        activeStep === 6 && <PrintBooking bookingData={resevedBookingData} userData={userInfos} handleBookingDone={handleBookingDone} salonName={artistData.companyName} appointment={appointment} slot={slot} />
                                    }
                                </CartBody>
                                <Fragment>
                                    {
